...
(define (generic-write obj display? width output)
  ...
  (define (wr obj col)
    ...
    (cond ((pair? obj)        (wr-expr obj col))
          ...
          ;; KRA 30JUN03: ((procedure? obj)   (out "#[procedure]" col))
	  ((procedure? obj)   (out (.toString obj) col))
	  ...
	  ;; KRA 12JUN02: (else               (out "#[unknown]" col))
	  (else               (out (stringify obj) col))
	  ))

  ;; KRA 12JUN02:
  (define (stringify obj)
    (if (eq? obj #null) "#null"
	(.toString (string-append "{" obj "}"))))
...
;;; KRA 12JUN02: JScheme does not have string-set!
(define (reverse-string-append l) (apply string-append (reverse l)))
